...
export default function AdvertEdit({ id }) {
    ...
    async function getData() {
      try{
        const result = await axiosClientAPI.get(`advert/${id}`, config)
        .then((response) => {
    ...
    const postData = async () => {
      ...
      try{
          const result = await axiosClientAPI.post(`advert/${id}`, formData, config)
          .then((response) => {
