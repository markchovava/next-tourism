        ...
        <section className='w-[100%]'>
         ...
         <section className='w-[100%]'>
          <div className='mx-auto w-[90%] flex items-center justify-end mb-8'>
            <Link href='/admin/profile/edit' className='text-white rounded-lg px-6 py-3 transition-all duration-200 ease-in-out bg-gradient-to-br from-green-500 to-blue-500 hover:gradient-to-br hover:from-blue-500 hover:to-green-600'>
              Edit Profile
            </Link>
          </div>
        </section>
