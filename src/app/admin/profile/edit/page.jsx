        ...
        <section className='w-[100%]'>
            <div className='mx-auto w-[90%] border-b border-slate-200'>
                <ul className='flex items-center justify-start gap-2 px-3 py-2'>
                    ...
                    <li><FaAngleRight /></li>
                    <li><Link href='/admin/profile/edit'>Edit Profile</Link></li>
                </ul>
            </div>
        </section>
         ...
         <section className='w-[100%]'>
          <div className='mx-auto w-[90%] flex items-center justify-end mb-8'>
            <Link href='/admin/profile' className='text-white rounded-lg px-6 py-3 transition-all duration-200 ease-in-out bg-gradient-to-br from-green-500 to-blue-500 hover:gradient-to-br hover:from-blue-500 hover:to-green-600'>
              View Profile
            </Link>
          </div>
        </section>
